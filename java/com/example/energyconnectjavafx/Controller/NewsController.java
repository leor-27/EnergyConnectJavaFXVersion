...
public class NewsController extends NavController implements Initializable {
    ...
    private String currentSort = "newest"; // in sorting
    private String currentKeyword = ""; // in searching
    private String activeCategory = null; // in category filtering
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // enable horizontal scroll in news container
        ...
        setupSearch(); // call search feature
        setupSorting(); // call sorting

        try {
            loadFeaturedNews(); // call getFeaturedNews()
            loadAllNews(); // call getAllNews()
    ...
    // Method for creating news card in UI
